import { Place, PlaceType, EventType } from '@/models';
...
describe('Activity Editor', () => {
  ...
  const eventTypes: Array<PlaceType> = [...EVENT_TYPES];

  it('exists', () => {
    render(<EventEditor types={eventTypes} onCancel={() => null} onConfirm={() => null} />);
