    ...
    const testCases: { name: string; value: EventDTO; expected: Event }[] = [
      {
        ...
        value: {
          ...
          itinerary_items: [
            {
              id: 14,
              name: 'Blow up the Earth',
              date: '2025-09-18',
              time: '06:00',
              description: 'The date and time itself are inconsequential so long as it is a Thursday.',
              event_rid: 42,
            },
            {
              id: 17,
              ...
              date: '2025-09-18',
              time: '06:03',
              description: 'Best to leave while they are still prepping and the Earth is still here.',
              event_rid: 42,
            },
          ],
        },
